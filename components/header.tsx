        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10'>
            ...
            <div className='hidden md:flex items-center justify-end md:flex-1 lg:w-0'>
                ...
                <Popover className='relative'>
                  {({ open }) => (
                    <>
                      <Popover.Button
                        id='create-post'
                        className='ml-8 mr-6  inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-2xl shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700'>
              ...
              <InboxIcon className='ml-2 h-8 w-8 mr-6 group-hover:text-gray-500 text-[#2a2a2b]' />
              <svg
                width='24'
                height='24'
                viewBox='0 0 20 24'
